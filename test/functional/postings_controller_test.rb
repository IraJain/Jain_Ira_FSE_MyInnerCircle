...
class PostingsControllerTest < ActionController::TestCase
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post :create, posting: { description: @posting.description, location: @posting.location, phone: @posting.phone, title: @posting.title, user_id: @posting.user_id }
    end
  ...
  test "should update posting" do
    put :update, id: @posting, posting: { description: @posting.description, location: @posting.location, phone: @posting.phone, title: @posting.title, user_id: @posting.user_id }
    assert_redirected_to posting_path(assigns(:posting))
  end
